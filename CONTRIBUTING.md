# How to contribute to Mes papiers?
...
- What is the version of the Mes papiers app?
...
```
$ git clone github.com/cozy/mespapiers.git
$ cd mespapiers
$ git remote add fork git://github.com/yourusername/mespapiers.git
```
...
Go to https://github.com/yourusername/mespapiers and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Mes papiers is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/mespapiers/issues/new
...
[localization]: https://github.com/cozy/mespapiers/blob/master/README.md#localization
