[![Travis build status shield](https://img.shields.io/travis/cozy/mespapiers/master.svg)](https://travis-ci.org/cozy/mespapiers)
[![Github Release version shield](https://img.shields.io/github/tag/cozy/mespapiers.svg)](https://github.com/cozy/mespapiers/releases)
...
Hacking the Cozy Mes papiers app requires you to [setup a dev environment][setup].
...
If you want to work on Mes papiers and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Mes papiers is [cozy](https://github.com/cozy), send him/her a :beers: to say hello!
...
Mes papiers is developed by cozy and distributed under the [AGPL v3 license][agpl-3.0].
