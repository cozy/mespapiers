...
* Add ForwardModal component [0.32.0](https://github.com/cozy/cozy-libs/releases/tag/cozy-mespapiers-lib%400.32.0), [0.32.3](https://github.com/cozy/cozy-libs/releases/tag/cozy-mespapiers-lib%400.32.3)

## ✨ Features

* Update cozy-ui to [68.1.1](https://github.com/cozy/cozy-ui/releases/tag/v68.1.1) and cozy-mespapiers-lib to 0.32.3
